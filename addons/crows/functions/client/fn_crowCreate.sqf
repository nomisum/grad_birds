...
["Crowe", position player, 50, 50, 50, 0] call GRAD_crows_fnc_crowCreate;
["Crowe", position player, 5, 10, 5, 0] call GRAD_crows_fnc_crowCreate;
...
for "_i" from 1 to _flockCount do {
	...
	_positionBehind = [1 - random 2, 0 - random 1, 1 - random 2];
