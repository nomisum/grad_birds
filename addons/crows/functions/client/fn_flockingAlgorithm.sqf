...
private _wp0 = AGLtoASL ([_flockPos, _flockArea, 00] call BIS_fnc_relPos);
private _wp1 = AGLtoASL ([_flockPos, _flockArea, 090] call BIS_fnc_relPos);
private _wp2 = AGLtoASL ([_flockPos, _flockArea, 180] call BIS_fnc_relPos);
private _wp3 = AGLtoASL ([_flockPos, _flockArea, 270] call BIS_fnc_relPos);
